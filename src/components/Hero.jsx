...
const Hero = () => {
  ...
  return (
    <section className="w-full md:font-serif mt-20">
      ...
      <div className="relative w-full mx-auto overflow-hidden h-[80vh]">

        {/* Desktop Video */}
        <div className="hidden md:block absolute inset-0">
          <div className="relative w-full h-full overflow-hidden">
            <iframe
              src="https://www.youtube.com/embed/HjSpbj8ARGo?autoplay=1&mute=1&loop=1&playlist=HjSpbj8ARGo&controls=0&modestbranding=1&rel=0&showinfo=0&iv_load_policy=3"
        ...
        <div className="block md:hidden absolute inset-0">
          <div className="relative w-full h-full overflow-hidden">
            <iframe
              src="https://www.youtube.com/embed/y5YHKnRZ9KA?autoplay=1&mute=1&loop=1&playlist=y5YHKnRZ9KA&controls=0&modestbranding=1&rel=0&showinfo=0&iv_load_policy=3"
