...
// const videos = [
//   { 
//     src: "https://www.youtube.com/embed/GGszOSAij1c?autoplay=1&mute=1&loop=1&playlist=GGszOSAij1c&controls=0&modestbranding=1&rel=0&showinfo=0", 
...
//   },
//   { 
//     src: "https://www.youtube.com/embed/m6P8nTSJ0Ps?autoplay=1&mute=1&loop=1&playlist=m6P8nTSJ0Ps&controls=0&modestbranding=1&rel=0&showinfo=0", 
...
//   },
//   { 
//     src: "https://www.youtube.com/embed/COXaIaIM_ck?autoplay=1&mute=1&loop=1&playlist=COXaIaIM_ck&controls=0&modestbranding=1&rel=0&showinfo=0", 
...
//   },
//   { 
//     src: "https://www.youtube.com/embed/sydTmSdnC8Q?autoplay=1&mute=1&loop=1&playlist=sydTmSdnC8Q&controls=0&modestbranding=1&rel=0&showinfo=0", 
...
//   },
//   { 
//     src: "https://www.youtube.com/embed/3csypTKYTXA?autoplay=1&mute=1&loop=1&playlist=3csypTKYTXA&controls=0&modestbranding=1&rel=0&showinfo=0", 
...
//   },
//   { 
//     src: "https://www.youtube.com/embed/UumTVf1VIgc?autoplay=1&mute=1&loop=1&playlist=UumTVf1VIgc&controls=0&modestbranding=1&rel=0&showinfo=0", 
...
//   },
//   { 
//     src: "https://www.youtube.com/embed/WtIw6bpjvdk?autoplay=1&mute=1&loop=1&playlist=WtIw6bpjvdk&controls=0&modestbranding=1&rel=0&showinfo=0", 
...
//   },
//   { 
//     src: "https://www.youtube.com/embed/j0yGc3J_Q20?autoplay=1&mute=1&loop=1&playlist=j0yGc3J_Q20&controls=0&modestbranding=1&rel=0&showinfo=0", 
...
//   },
//   { 
//     src: "https://www.youtube.com/embed/UltskLI2WBU?autoplay=1&mute=1&loop=1&playlist=UltskLI2WBU&controls=0&modestbranding=1&rel=0&showinfo=0", 
...
//   },
//   { 
//     src: "https://www.youtube.com/embed/S06MJdUMZcA?autoplay=1&mute=1&loop=1&playlist=S06MJdUMZcA&controls=0&modestbranding=1&rel=0&showinfo=0", 
...
//   },
//   { 
//     src: "https://www.youtube.com/embed/3_iBiMiW-hE?autoplay=1&mute=1&loop=1&playlist=3_iBiMiW-hE&controls=0&modestbranding=1&rel=0&showinfo=0", 
...
//       {/* Custom Purple Cursor - BIGGER SIZE */}
//       <motion.div
...
//                   <div className="absolute inset-0 bg-black/30 group-hover:bg-black/20 transition-all duration-400"></div>
//                 </div>
...
//                 {/* Description Section - ONLY TITLE AND DESCRIPTION */}
...
import React, { useState, useEffect, useRef } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { X, Play } from "lucide-react"; // Import Play icon for the thumbnail overlay
import { LettersPullUp } from "../components/LettersPullUp";
...
// Videos array (Unchanged - sources were cleaned in the last step)
const videos = [
  {
...
export default function Projects() {
  ...
  /**
   * MODAL VIDEO SOURCE (Minimal Controls)
   */
  const getModalVideoSrc = (baseSrc) => {
    const videoId = getVideoId(baseSrc);
    // Use controls=2, modestbranding=1, and disablekb=1 for minimal UI.
    // autoplay=1 starts playback immediately when the modal opens.
    return `https://www.youtube.com/embed/${videoId}?autoplay=1&controls=2&modestbranding=1&disablekb=1&rel=0&showinfo=0`;
  }
  ...
  const getGridThumbnailSrc = (baseSrc) => {
    const videoId = getVideoId(baseSrc);
    // Use the max-quality YouTube thumbnail.
  ...
  return (
    <div className="w-full min-h-screen bg-[#3B1C57] text-white relative py-20 px-4 md:px-8">
      ...
      {/* Custom Purple Cursor - BIGGER SIZE (Unchanged) */}
      <motion.div
        className="fixed pointer-events-none z-50"
        animate={{
          x: cursorPosition.x - 45,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {videos.map((video, index) => {
            ...
            return (
              ...
              >
                <div className="w-full h-full relative">
                  {/* MODIFICATION: Use a static image thumbnail instead of the iframe */}
                  <img
        ...
        {activeVideo && (
          ...
          >
            <motion.div
              ...
              onClick={(e) => e.stopPropagation()}
            >
              {/* Header with Title and Close Button (Unchanged) */}
              <div className="flex justify-between items-start p-6 md:p-8 border-b border-gray-800">
                <div className="flex-1 pr-4">
                  <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">
                    {activeVideo.title}
